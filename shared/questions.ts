...
export const questions: Question[] = [
  {
    ...
    choices: [
      ...
      { id: "c", label: "낑낑거리거나 출입문 근처를 서성인다", weights: { I: 1, F: 1 } }
    ]
  },
  {
    id: "q2",
    ...
    choices: [
      ...
      { id: "b", label: "먼저 관찰하고 천천히 접근한다", weights: { I: 2, N: 1 } },
  ...
  },
  {
    ...
    choices: [
      { id: "a", label: "점프/꼬리 흔들기 등 강한 환영", weights: { E: 2, F: 2 } },
      { id: "b", label: "차분히 다가와 냄새를 맡는다", weights: { I: 2, T: 2 } },
  ...
  },
  {
    ...
    text: "산책 스타일은 어떤가요?",
    choices: [
      { id: "a", label: "앞장서서 새로운 길/냄새를 찾는다", weights: { E: 2, N: 1 } },
      { id: "b", label: "주인의 옆에서 일정하게 보조를 맞춘다", weights: { S: 2, J: 2 } },
      { id: "c", label: "그날 기분에 따라 유연하게 바뀐다", weights: { N: 1, P: 2 } }
    ]
  },
  {
    id: "q7",
    text: "산책 루트가 바뀌면?",
    choices: [
      { id: "a", label: "흥미로워하며 즐긴다", weights: { N: 2, P: 1 } },
      { id: "b", label: "처음엔 낯설지만 곧 적응한다", weights: { S: 1, J: 1 } },
      { id: "c", label: "스트레스를 받거나 걷기를 거부한다", weights: { S: 2, J: 2, F: 1 } }
    ]
  },
  {
    id: "q8",
    ...
    choices: [
      { id: "a", label: "바로 물어오거나 가지고 논다", weights: { E: 2, P: 2 } },
  ...
  },
  {
    ...
    choices: [
      { id: "a", label: "즉시 물어뜯고 탐색한다", weights: { E: 2, P: 2 } },
      { id: "b", label: "조심스레 관찰 후 천천히 사용한다", weights: { N: 1, P: 1 } },
      { id: "c", label: "거의 사용하지 않는다", weights: { I: 2, J: 2 } }
    ]
  },
  {
    id: "q10",
    ...
    choices: [
      { id: "a", label: "터그/페치 같은 에너지 높은 놀이", weights: { E: 2, P: 2 } },
      { id: "b", label: "후각/퍼즐처럼 생각하는 놀이", weights: { N: 1, T: 3 } },
      { id: "c", label: "스킨십/조용한 교감", weights: { I: 2, F: 2 } }
    ]
  },
  {
    id: "q11",
    ...
    choices: [
      { id: "a", label: "소리 쪽으로 다가가 확인한다", weights: { E: 2, N: 2 } },
      { id: "b", label: "잠깐 멈추고 상황을 살핀다", weights: { I: 2, T: 2 } },
  ...
  },
  {
    ...
    choices: [
      { id: "a", label: "주도적으로 대응하거나 다가간다", weights: { E: 2, T: 2 } },
  ...
  },
  {
    ...
    choices: [
      { id: "a", label: "잠시 쳐다보다 자기 할 일을 한다", weights: { I: 2, T: 2 } },
  ...
  },
  {
    ...
    choices: [
      ...
      { id: "c", label: "스트레스/파괴 행동이 나타난다", weights: { E: 2, F: 2 } }
    ]
  },
  {
    id: "q15",
  ...
  },
  {
    ...
    choices: [
      { id: "a", label: "즉시 달려온다", weights: { E: 2, F: 2 } },
      { id: "b", label: "한 번 더 부르면 온다", weights: { I: 2, J: 2 } },
      { id: "c", label: "보상이 있을 때 더 잘 온다", weights: { T: 2, P: 2 } }
    ]
  },
  {
    id: "q17",
    ...
    choices: [
      { id: "a", label: "조용히 곁에 와서 기대어 있는다", weights: { I: 2, F: 2 } },
      { id: "b", label: "산책/놀이로 기분 전환을 유도한다", weights: { E: 2, N: 2 } },
      { id: "c", label: "눈치를 보며 거리를 둔다", weights: { T: 2, J: 2 } }
    ]
  },
  {
    id: "q18",
    ...
    choices: [
      { id: "a", label: "자연스럽게 혼자 놀거나 쉰다", weights: { I: 2, T: 2 } },
      { id: "b", label: "주인의 주의를 끌려고 한다", weights: { E: 2, F: 2 } },
  ...
  },
  {
    ...
    choices: [
      { id: "a", label: "바짝 붙어 몸을 기대고 있다", weights: { F: 2, I: 2 } },
      { id: "b", label: "근처에서 자유롭게 왔다 갔다 한다", weights: { E: 2, P: 2 } },
      { id: "c", label: "자기 자리/매트 고정 자리", weights: { S: 1, J: 1 } }
    ]
  },
  {
    id: "q20",
  ...
  },
  {
    ...
    choices: [
      { id: "a", label: "명확한 지시에 잘 따른다", weights: { S: 2, J: 1 } },
      { id: "b", label: "보상이 있으면 더 잘 따른다", weights: { F: 1, P: 1 } },
      { id: "c", label: "지시보다 놀이를 선호한다", weights: { E: 1, P: 1 } }
    ]
  },
  {
    id: "q22",
  ...
  },
  {
    ...
    choices: [
      { id: "a", label: "금방 이해하고 따라 한다", weights: { N: 1, T: 3 } },
      { id: "b", label: "몇 번 반복하면 익힌다", weights: { S: 2, J: 1 } },
      { id: "c", label: "천천히, 꾸준한 반복이 필요하다", weights: { S: 1, J: 1, I: 1 } }
    ]
  },
  {
    id: "q25",
    text: "산책 중 줄을 당겼을 때(리드 반응)는 어떻게 하나요?",
    choices: [
      { id: "a", label: "주인이 줄을 당기면 곧바로 속도를 조절해 맞춰 걷는다", weights: { J: 1, T: 1 } },
      { id: "b", label: "줄에는 반응하지만 흥미로운 자극이 있으면 쉽게 다른 쪽으로 향한다", weights: { P: 2, N: 1 } },
      { id: "c", label: "줄 텐션을 일정하게 유지하며 안정적으로 걷는다", weights: { S: 1, J: 1 } }
    ]
  },
  {
    id: "q26",
  ...
  },
  {
    ...
    choices: [
      { id: "a", label: "호기심 많아 바로 먹어본다", weights: { E: 1, P: 2 } },
  ...
  },
  {
    ...
    choices: [
      { id: "a", label: "쉽게 친구가 되려 다가간다", weights: { E: 1, F: 1 } },
  ...
  },
  {
    ...
    choices: [
      { id: "a", label: "늘 다니던 익숙한 길이 편안하다", weights: { S: 2, J: 1 } },
      { id: "b", label: "주로 익숙한 길이지만 가끔 새로운 길도 좋다", weights: { S: 1, N: 1 } },
      { id: "c", label: "새로운 길을 보면 신나서 앞장선다", weights: { N: 2, P: 1 } }
    ]
  },
  {
    id: "q32",
    text: "장난감 취향은 어떤가요?",
    choices: [
      { id: "a", label: "늘 쓰던 익숙한 장난감을 가장 좋아한다", weights: { S: 2, J: 1 } },
      { id: "b", label: "익숙한 것과 새로운 것을 상황에 따라 고른다", weights: { S: 1, N: 1 } },
      { id: "c", label: "새로운 장난감에 더 큰 흥미를 보인다", weights: { N: 2, P: 1 } }
    ]
  },
  {
    id: "q33",
    ...
    choices: [
      { id: "a", label: "늘 먹던 익숙한 맛을 가장 잘 먹는다", weights: { S: 2, J: 1 } },
      { id: "b", label: "새로운 맛도 시도하지만 익숙한 게 더 편하다", weights: { S: 1, N: 1 } },
      { id: "c", label: "새로운 간식이 나오면 더 흥미를 보인다", weights: { N: 2, P: 1 } }
    ]
  },
  {
    id: "q34",
    text: "훈련 방식 선호는 어떤가요?",
    choices: [
      { id: "a", label: "같은 동작을 반복하며 안정적으로 수행한다", weights: { S: 2, J: 2 } },
      { id: "b", label: "기본은 반복하되 가끔은 변화를 준다", weights: { S: 1, N: 1 } },
      { id: "c", label: "새로운 동작을 자주 배우며 변화를 즐긴다", weights: { N: 2, P: 2 } }
    ]
  },
  {
    id: "q35",
    ...
    choices: [
      { id: "a", label: "한곳에 앉아 세부적으로 냄새를 맡고 관찰한다", weights: { S: 2, T: 1 } },
      { id: "b", label: "조금 돌아보다 금방 익숙해진다", weights: { S: 1, N: 1 } },
      { id: "c", label: "전체 공간을 빠르게 돌아다니며 탐험한다", weights: { N: 2, P: 1 } }
    ]
  },
  {
    id: "q36",
    ...
    choices: [
      { id: "a", label: "목소리 톤·걸음걸이 같은 작은 변화도 잘 알아차린다", weights: { S: 2, J: 1 } },
      { id: "b", label: "상황에 따라 눈치채기도 하고 못 느끼기도 한다", weights: { S: 1, N: 1 } },
      { id: "c", label: "큰 분위기 변화가 있어야 반응한다", weights: { N: 2, I: 1 } }
    ]
  }
];
